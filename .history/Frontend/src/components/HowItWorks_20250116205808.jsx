    ...
    <section className='howItWorks'>
        ...
        <div className='container'>
            ...
            <div className='card'>
                ...
                <p>
                    Employers can post detailed job description, and job seekers can browse a comprehensive list of available position. Utilize filters to find jobs that match your skills and preferences.
                </p>
            </div>
        </div>
    </section>
