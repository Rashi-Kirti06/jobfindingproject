    ...
    <section className='howItWorks'>
        ...
        <div className='container'>
            ...
            <div className='card'>
                ...
                <p>
                    Employers can post detailed job description, and job seekers 
                    can browse a comprehensive list of available position. Utilize 
            ...
            <div className='card'>
                ...
                <p>
                    Employer can shortlist candidates and extend job offers. Job seekers can review job offers and accept positions that align with their career goals.
                </p>
            </div>
        </div>
    </section>
