...
export const getAllJob = catchAsyncErrors(asyncs
export const getMyJobs = catchAsyncErrors(async
export const deleteJob = catchAsyncErrors(async
export const getASingl = catchAsyncErrors(asynceJob
