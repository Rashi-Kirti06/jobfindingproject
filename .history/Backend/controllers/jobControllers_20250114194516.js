...
export const getAllJob = catchAsyncErrors(async(ress
export const getMyJobs = catchAsyncErrors(async(res
export const deleteJob = catchAsyncErrors(async(res
export const getASingl = catchAsyncErrors(async(reseJob
