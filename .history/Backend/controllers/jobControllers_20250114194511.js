...
export const getAllJob = catchAsyncErrors(ss
export const getMyJobs = catchAsyncErrors(s
export const deleteJob = catchAsyncErrors(s
export const getASingl = catchAsyncErrors(seJob
